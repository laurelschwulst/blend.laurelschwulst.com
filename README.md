...
This is a simple image viewer for my Are.na channel of found images. It's based on Damon Zucconi's [Atlas](http://atlas.damonzucconi.com).

### index-to-come.php
+ this will be like the splash page
+ it will always show just 4 images
+ todo: right now it just shows the first 4 images, but i would like it to show random 4 images pulled from channel
...
### other:
+ when i make the channel “private”, all the contents disappear. is there a way to make it private and still see the content?
