...
This is a simple image viewer for my Are.na channel of found images. It's based on Damon Zucconi's [Atlas](http://atlas.damonzucconi.com) and using the [Are.na PHP API](https://github.com/arenahq/arena-php).
